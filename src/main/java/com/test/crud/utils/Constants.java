package com.test.crud.utils;


public class Constants {

    public static final int IDENTIFICACTION_SIZE = 10;
    public static final String NOT_EMPLOYEE = "There is no employee with that identification";
    public static final String NOT_DATE = "Validate DATE";
    ...
    public static final int CODE_ERROR_DATE = 604;
    ...
    public static final String NOT_INFORMATION = "No records of vaccinated employees";

    public static final String NOT_DATE_REQUEST = "There is no record between the dates";

    public static final String NOT_TYPE = "There is no type of covid vaccine entered";
